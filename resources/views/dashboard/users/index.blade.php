                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <button class="btn btn-sm btn-info">
                                    <a style="color: white;text-decoration: none" href={{route('dashboard.user.showFormSendMessage',$user->id)}}><i class="fa fa-send-o" aria-hidden="true"></i>@lang('site.send message')</a>
                                </button>
